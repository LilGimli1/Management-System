...
#Importing From sales.p
	...
	text_widget.insert(INSERT, (x.get(), y.get(), z.get()))
...
def SalesGUI():
	...
	ttk.Button(mainframe, text="Add", width = 23, padding="5 5 5 5", command=Addfunction).grid(column=0, row=1, sticky=S)
	...
	ttk.Button(mainframe, text="Import", width = 23, padding="5 5 5 5", command=ImportSales).grid(column=3, row=1, sticky=S)
